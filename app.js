...
app.post("/book",upload.single("image") ,async(req,res)=>{
    ...
    if(!req.file){
       ...
       fileName = "https://mern-book-store-frontend-gamma.vercel.app/" + req.file.filename
    }
...
app.patch("/book/:id",upload.single('image'), async (req,res)=>{
    ...
    if(req.file){
        ...
        const localHostUrlLength = "https://mern-book-store-frontend-gamma.vercel.app/".length
